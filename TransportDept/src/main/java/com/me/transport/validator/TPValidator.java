...
@Component
public class TPValidator extends DAO implements Validator{

	@Override
	public boolean supports(Class<?> clazz) {
		return clazz.isAssignableFrom(TrafficPolice.class);
	}

	@Override
	public void validate(Object target, Errors errors) {
		// TODO Auto-generated method stub
				TrafficPolice p = (TrafficPolice) target;
				...
				Criteria c1 = getSession().createCriteria(TrafficPolice.class);
				c1.add(Restrictions.eq("badgeId", p.getBadgeId()));
				c1.setMaxResults(1);
				if(c1.uniqueResult()!=null) {
					errors.rejectValue("badgeId", "badgeId-Exists", "Badge Id  already exists in our System. Please enter the right Badge Id or login if you have already registered!");
				}				
				...
				ValidationUtils.rejectIfEmptyOrWhitespace(errors, "badgeId", "badgeId-password","Badge Number cannot be left Blank");
