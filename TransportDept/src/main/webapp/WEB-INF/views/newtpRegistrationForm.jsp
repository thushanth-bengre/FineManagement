...
<div align="center">
<h1>Traffic Police Registration Form</h1>
</div>

<div align="left">
	<h2>Please Enter your Information Below</h2>
        <form:form action ="newTp" method="post" modelAttribute="person">
            ...
            Badge Id:   <form:input path="badgeId"/> <form:errors path="badgeId"/><br/><br/>            
