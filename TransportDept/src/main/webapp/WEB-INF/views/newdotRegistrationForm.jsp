...
<div align="center">
<h1>Department of Transport Registration Form</h1>
</div>

<div align="left">
	<h2>Please Enter your Information Below</h2>
        <form:form action ="newDOT" method="post" modelAttribute="person">
            ...
            Employee Id:   <form:input path="employeeId"/> <form:errors path="employeeId"/><br/><br/>            
