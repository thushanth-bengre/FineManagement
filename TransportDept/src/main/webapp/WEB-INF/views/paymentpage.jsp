...
<div align="left">
	<h2>Please enter Payment details below</h2>
        <form:form action = "paymentdone" method="post">
        Fine Id: 	<c:out value="${fine.fineId}"></c:out><br /><br />
        Title: 							<c:out value="${fine.title}"></c:out><br /><br />
        Amount: 					<c:out value="${fine.amount}"></c:out><br /><br />       
            Credit Card #:  <input type="text" /> <br /><br />
            Expiry:   	<input type="text" /><br/><br/>            
