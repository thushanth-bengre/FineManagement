...
<div align="center">
<h1><font face = "Courier" color="#000000" size="7">License Plates</font></h1>
        <table border="1">
                    <tr>
                        <th>Plate Number</th>                        
                        <th>Vehicle</th>                                           
                    </tr>
                    <c:forEach items="${licensePlates}" var="plates">
                    <tr>
                        <th><c:out value="${plates.lpNumber}"  /></th>
                        <th><c:out value="${plates.vehicle.vin}" /></th>                                       
                    </tr>
                </c:forEach>
        </table> 
        <a href="addLicensePlate.htm">Click here to add new License Plate</a>
</div>
