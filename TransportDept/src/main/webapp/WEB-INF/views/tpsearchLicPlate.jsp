...
<div align="center">
<h1><font face = "Courier" color="#000000" size="7">Add Fine</font></h1>
<h2><font face = "Courier" color="#000000" size="5">Enter License Plate Number Below!</font></h2>
<form name='searchLicPlate' action="addfines" method="post">
              	<input type="text" name="lp"  /><br/><br/>
