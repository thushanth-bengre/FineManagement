<%@page import="com.me.transport.pojo.FineStatus"%>
...
<div align="center">
<h1><font face = "Courier" color="#000000" size="7">Fines</font></h1>
        <table border="1">
                    <tr>
                        <th>Title</th>                        
                        <th>Amount</th>                         
                    ...
                    <tr>
                        <th><c:out value="${fine.title}"  /></th>
                        <th><c:out value="${fine.amount}" /></th>
                        <th><c:out value="${fine.summary}" /></th>                      
                        <th><c:out value="${fine}" /></th>                        
                        <c:if test="${fine == 'NEW' }">
                        <th><a href="payment.htm?id=${fine.fineId}">Click Here to pay</a></th>
                        </c:if>
                    </tr> 
                </c:forEach>
        </table> 
...
<div id="moreInfo" align="center" style="color:white; font-weight:large;">
