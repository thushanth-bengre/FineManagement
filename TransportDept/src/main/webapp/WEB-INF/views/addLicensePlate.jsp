...
<div align="center">
<h1>Add LicensePlate</h1>
</div>

<div align="left">
	<h2>Please enter License Plate Number below</h2>
        <form:form action = "saveLicensePlate" method="post" modelAttribute="licensePlate">       
            License Plate Number:   <form:input path="lpNumber"/> <form:errors path="lpNumber"/><br /><br />                                
           <input type="submit" value="Add License Plate" class="button"/>           
        </form:form>
</div>
