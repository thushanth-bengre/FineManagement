...
<div align="center">
<h2><font face = "Courier" color="#000000" size="5">Select License Plate</font></h2>    
</div>

<div align="center">
<form name='licplate' action="addVehicle" method="post">
<select name="LicensePlate">		
        <c:forEach var="lp" items="${plates}">
            <option value="${lp.lpNumber}"> ${lp.lpNumber} </option>
        </c:forEach>
    </select>
